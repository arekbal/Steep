  ...
  public static class StrExtensions
  {
    ...
    public static void ToStr4(this int that, out Str4 s)
    {
      ...
      { 
        ...
        throw new ArgumentOutOfRangeException("too big of a number to fit in Str4 (including a sign)");
      }
      ...
      throw new ArgumentOutOfRangeException("too big of a number to fit in Str4");
    }

...
namespace doix.Fast.VarByteSize
{
  ...
  public struct VarUInt62
  {
    ...
    static readonly ulong Offset = (ulong)Math.Pow(2, 62);
    ...
    {
      if (val > MaxValue)
        throw new OverflowException("VarUInt62 cannot contain so big ulong value");

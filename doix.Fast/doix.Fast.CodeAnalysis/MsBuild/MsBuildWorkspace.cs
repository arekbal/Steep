...
// Derivative work with changes by Arek Bal
...
#pragma warning restore CS0436 // Type conflicts with imported type
  {
    ...
    //public override bool TryApplyChanges(Solution newSolution)
    //{    
    //    return base.TryApplyChanges(newSolution, new ProgressTracker());
    //}
    ...
    //  using (_serializationLock.DisposableWait())
    //  {
    //    //var tryApplyChangesMethod = typeof(Workspace).GetMethod("TryApplyChanges", System.Reflection.BindingFlags.NonPublic);

    //    //Workspace b = this;
    //    //return (bool)tryApplyChangesMethod.Invoke(b, new object[] { newSolution, progressTracker });

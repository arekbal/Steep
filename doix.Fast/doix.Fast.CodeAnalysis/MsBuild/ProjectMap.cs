...
namespace doix.Fast.CodeAnalysis.MsBuild
{
  ...
  public class ProjectMap
  {
    ...
    public void Add(Project project)
    {
      ...
      var stateProp = typeof(Workspace).GetProperty("State", System.Reflection.BindingFlags.NonPublic);
      var projectState = stateProp.GetValue(project);
      var projectState_ProjectInfo_Prop = projectState.GetType().GetProperty("ProjectInfo", System.Reflection.BindingFlags.NonPublic);

      AddProjectInfo((ProjectInfo)projectState_ProjectInfo_Prop.GetValue(projectState));
    ...
    internal void AddProjectInfo(ProjectInfo projectInfo)
    {
      ...
      if (projectInfos.Any(pi => pi.Id == projectInfo.Id))
      {

...
namespace doix.Fast.Analyzers
{
  [DiagnosticAnalyzer(LanguageNames.CSharp)]
  public class DisableCopyAnalyzer : DiagnosticAnalyzer
  {
    public const string DiagnosticId = "doixFast_DisableCopy_Analyzer";
    ...
    static DiagnosticDescriptor Rule = new DiagnosticDescriptor(DiagnosticId, Title, MessageFormat, Category, DiagnosticSeverity.Warning, 
    ...
    public override void Initialize(AnalysisContext context)
    {
      ...
      context.RegisterSyntaxNodeAction(AnalyzeBinaries, new[] { OperationKind.SimpleAssignment });
    }
    ...
    static void AnalyzeBinaries(SyntaxNodeAnalysisContext context)
    {
      // TODO: Replace the following code with your own analysis, generating Diagnostic objects for any issues you find
      var node = context.Node as AssignmentExpressionSyntax;

      if(node.OperatorToken.Kind() == SyntaxKind.SimpleAssignmentExpression)
      {
